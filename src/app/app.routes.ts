  ...
  },
  {
    ...
    children: [
      { path: 'dashboard', component: DashboardPage },
      {
        ...
        data: { permissions: ['USER_MANAGE', 'USER_VIEW'] },
      },
      {
      ...
      },
      {
        ...
        canActivate: [permissionGuard],
        data: { permissions: ['BRAND_MANAGE', 'BRAND_VIEW'] },
      },
      {
        path: 'catalog/categories',
        component: CategoriesPage,
        canActivate: [permissionGuard],
        data: { permissions: ['CATEGORY_MANAGE', 'CATEGORY_VIEW'] },
      },
      {
        path: 'catalog/products',
        component: ProductsPage,
        canActivate: [permissionGuard],
        data: { permissions: ['PRODUCT_MANAGE', 'PRODUCT_VIEW'] },
      },
      {
        path: 'catalog/attributes',
        component: AttributesPage,
        canActivate: [permissionGuard],
        data: { permissions: ['ATTRIBUTE_MANAGE', 'ATTRIBUTE_VIEW'] },
      },
      {
        path: 'catalog/search',
        component: SearchPage,
        canActivate: [permissionGuard],
        data: { permissions: ['SEARCH_VIEW'] },
      },
